...
def transition_func(grid, neighbourstates, neighbourcounts, decaygrid_for_chaparral, decaygrid_for_grassland, decaygrid_for_forest):
    ...
    # if 1 live neighbour and is dead -> cell born
    birth_of_chaparral_fire = ((chaparral_burning > 0) | (forest_burning > 0) | (grassland_burning > 0)) & (grid == 0) & (grid != 6) & ((randint(1, 100)) > 91)
    birth_of_grassland_fire = ((chaparral_burning > 0) | (forest_burning > 0) | (grassland_burning > 0)) & (grid == 2) & (grid != 6) & ((randint(1, 100)) > 91)
    birth_of_forest_fire = ((chaparral_burning > 0)  | (forest_burning > 0) | (grassland_burning > 0)) & (grid == 4) & (grid != 6) & (((randint(1, 100)) > 91))
